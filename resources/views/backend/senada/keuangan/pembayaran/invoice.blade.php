            ...
            <table style="width: 100%; table-layout: fixed">
              ...
              ">
                        <div>
                            ...
                            <p style="font-size: 12px">Nama : <b>{{ $pembayaran[0]->name }}</b>, Kelas : <b>{{ $pembayaran[0]->class_id }}</b></p>
                            <p style="font-size: 12px">Nomor Transaksi :<b>{{ $pembayaran[0]->transaction_order }}</b></p>
                            <p style="font-size: 12px">Tanggal Transaksi :
                                <b>{{ $pembayaran[0]->transaction_date }}</b></p>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <tbody>
                ...
                @foreach ($pembayaran as $item)
                    <tr>
                        ...
                        <td style="font-size: 12px">@currency($item->transaction_fee)</td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot></tfoot>
        ...
        <table class="hm-p table-bordered" style="width: 100%; margin-top: 30px">
            ...
            <tr style="background: #84C225">
                ...
                <td style="width: 200px; text-align: right; border-right: none">
                    <p style="text-align: left">@currency($pembayaran->sum('transaction_total'))</p>
                </td>
                <td colspan="5" style="border-left: none"></td>
            </tr>
        </table>
